                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('book.edit', $book->slug) }}" class="btn btn-sm btn-warning text-nowrap">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            {!! Form::open(['route' => ['book.destroy', $book->slug], 'method' => 'DELETE', 'class'=>'d-inline']) !!}
                                            <button type="submit" class="btn btn-sm btn-danger text-nowrap" onclick="deleteSubmit(this, event)" data-toggle="tooltip" title="Delete" data-placement="top">
